...
<p align="center">
  <a href="https://github.com/oliverames/skylight-bridge/releases/tag/v1.5.7">
    <img src="https://img.shields.io/badge/macOS-v1.5.7-f5a542?style=flat-square&logo=apple&logoColor=white" alt="macOS release 1.5.7">
  </a>
  <a href="#license">
...
Version 1.5.7 fixes Apple Notes sync failures in large or nested folder hierarchies and HTTP 422 errors for one-off chores. Removing a Chore Chart mapping now also lets you choose which side to keep. If you want to verify the download, compare the output below with the checksum file beside the DMG on the release page.

```bash
shasum -a 256 ~/Downloads/Skylight.Bridge-1.5.7.dmg
```
