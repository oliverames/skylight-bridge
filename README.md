...
<p align="center">
  <a href="https://github.com/oliverames/skylight-bridge/releases/tag/v1.5.8">
    <img src="https://img.shields.io/badge/macOS-v1.5.8-f5a542?style=flat-square&logo=apple&logoColor=white" alt="macOS release 1.5.8">
  </a>
  <a href="#license">
...
Version 1.5.8 prevents duplicate recurring chores, adopts existing reminders more reliably, adds cross-device sync coordination, and avoids uploading duplicate photos. If you want to verify the download, compare the output below with the checksum file beside the DMG on the release page.

```bash
shasum -a 256 ~/Downloads/Skylight.Bridge-1.5.8.dmg
```
