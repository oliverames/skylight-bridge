...
<p align="center">
  <a href="https://github.com/oliverames/skylight-bridge/releases/tag/v1.5.9">
    <img src="https://img.shields.io/badge/macOS-v1.5.9-f5a542?style=flat-square&logo=apple&logoColor=white" alt="macOS release 1.5.9">
  </a>
  <a href="#license">
...
Version 1.5.9 fixes the macOS permission-request flow for Apple Photos, Reminders, and Notes, including Tahoe's stricter consent handling. If you want to verify the download, compare the output below with the checksum file beside the DMG on the release page.

```bash
shasum -a 256 ~/Downloads/Skylight.Bridge-1.5.9.dmg
```
