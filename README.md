...
<p align="center">
  <a href="https://github.com/oliverames/skylight-bridge/releases/tag/v1.6.2">
    <img src="https://img.shields.io/badge/macOS-v1.6.2-f5a542?style=flat-square&logo=apple&logoColor=white" alt="macOS release 1.6.2">
  </a>
  <a href="#license">
...
Version 1.6.2 is a correctness release. It fixes selected-photo Cloud reconciliation races, so two overlapping syncs can no longer disagree about which assets a mapping owns. If you want to verify the download, compare the output below with the checksum file beside the DMG on the release page.

```bash
shasum -a 256 ~/Downloads/Skylight.Bridge-1.6.2.dmg
```
